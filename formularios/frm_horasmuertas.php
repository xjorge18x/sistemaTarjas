...
<div class="chart">
    ...
    <div class="form-row ">
        ...
        <div id="resultado">
          ...
          <select id="idTipoSalida" name="idTipoSalida" class="form-control" >
        ...
        <div class="form-group col-md-5 col-sm-4">
          ...
          <select  name="id_ocupacion" id="id_ocupacion" class="form-control" onchange="cargarSelectv1(3,this.value,'divGrupo');" required>
          <OPTION value="" selected>SELECCIONAR...</OPTION>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2 col-sm-2">
        <select id="idTipoProceso" name="idTipoProceso" class="form-control" disabled="">
