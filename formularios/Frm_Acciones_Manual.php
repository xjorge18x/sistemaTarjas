...
<span aria-hidden="true" style="font-size: 2.5rem;">&times;</span>
    ...
    <form method="POST" name="ResitrarAccionesManuales" id="ResitrarAccionesManuales">
     ...
     <input type="hidden" name="CodDetalle" id="CodDetalle" value="<?= $CodDetalle; ?>">
...
<button type="button" class="btn btn-primary" onclick="RegistrarAcionesManuales(); return false">Guardar</button>
</div>
