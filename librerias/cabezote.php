            ...
            <a class="navbar-brand hidden-md-down logo" href="#"> <img src="img/Logo-blanco.png" width="40" height="40" alt="">COINREFRI SRL</a>
            ...
            <section class="box-model">
                 <ul class="user-penal">
                    ...
                    <li> <a href="#1" onclick="javascript:cargarArchivo('contenido','contenedor/formularios/frm_mantenimientoUsuario.php')"><i class="fal fa-user-tie"></i> Mis Datos <span class="label label-success">4</span></a> </li>
