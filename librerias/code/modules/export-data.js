	...
	q(c, "modules/export-data.src.js", [c["parts/Globals.js"], c["parts/Utilities.js"]], function(b, a) {
		...
		b.setOptions({
			...
			lang: {
				...
				viewData: "Ver en tabla los datos"
			}
		});
		...
		b.Chart.prototype.getDataRows = function(a) {
			var c = this.hasParallelCoordinates,
				...
				y, z = function(k, c, g) {
					...
					return k ? k instanceof b.Axis ? k.options.title && k.options.title.text || (k.isDatetimeAxis ? "DateTime" : "Categoría") : a ? {
						columnTitle : 1 < g ? c : k.name, topLevelColumnTitle : k.name
					}: k.name + (1 < g ? " (" + c + ")" : ""): "Categoría"
				},
				D = function(a, c, g) {
					var k = {},
						d = {};
			...
			this.series.forEach(function(k) {
				...
				if (!1 !== k.options.includeInDataExport && !k.options.isInternal && !1 !== k.visible) {
					...
					for (m = 0; m < r;) y = z(k, t[m], t.length), n.push(y.columnTitle || y), a && p.push(y.topLevelColumnTitle || y), m++;
					var q = {
						chart: k.chart,
					...
					k.options.data.forEach(function(a, b) {
						...
						d[a].x = g.x;
						d[a].name = l;
						for (d[a].xValues[f] = g.x; m < r;) b = t[m], l = g[b], d[a][u + m] = e(B.categoryMap[b][l], B.dateTimeValueAxisMap[b] ? h.dateFormat(w.dateFormat, l) : null, l), m++
					});
		...
		}), a.buttons && a.buttons.contextButton.menuItems.push("separator", "downloadCSV", "downloadXLS", "viewData");//aqui borre
