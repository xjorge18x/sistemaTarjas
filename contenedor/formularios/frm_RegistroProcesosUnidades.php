...
<div class="main1">
<div class="widget">
<div class="title">Registro Envío mesa Fileteros</div>
<div class="chart">
 <div class="container-fluid" id="mycontainer">  
	<div class="form-row">
	        <div class="form-group col-md-5 col-sm-6">
	            <label for="id_ocupacion" >Selecione Ocupación</label>
	            <select  name="id_ocupacion" id="id_ocupacion" class="form-control" onchange="cargarSelectv1(4,this.value,'divGrupo');" required>
				...
				where t.estado=0 and c.estado=1 and c.codigoTipoTarifa=2 and g.Estado=1 and o.estado=1";
	        ...
	        <div class="form-group col-md-5 col-sm-6">
	            ...
	            inner join TurnoGenerado t on (t.codigoturno=c.codigoTurno)
	            where c.codigoOcupacion=".$row_p["codOcupacion"]." and t.Estado=0 and c.estado=1";
        	...
        	<label for="id_Grupo">Num. DINO</label>
			<input class="form-control" type="number" name="id_cantidad" id="id_cantidad" min="1" onkeypress="return isNumberKey(this);" required="" disabled="">
		</div>
	...
	<div class="form-row">
		...
		<div class="form-group col-md-12 col-sm-6">
			...
			<input type="submit" name="guardar" id="guardar" value="Enviar" class="form-control btn-dark" onclick="EnviarProceso(); return false" disabled="">
		</div>
	</div>
</div><!-- cierre div container formulario--> 	
