...
<div class="main1">
<div class="widget">
<div class="title">Registro de Proceso Grupal (KG)</div>
<div class="chart">
...
<div class="form-row justify-content-center">
			...
			<div class="form-group col-md-3 col-sm-3">
	            ...
	            <select  name="id_Especie" id="id_Especie" class="form-control form-control-sm" onchange="cargarSelectv1(14,this.value,'divOcupacion');" required>
			 ...
			 <div class="form-group col-md-3 col-sm-3">
			 	<div id="divOcupacion" >
		            ...
		            <select  name="id_ocupacion" id="id_ocupacion" class="form-control form-control-sm" onchange="cargarSelectv1(5,this.value,'divGrupo');" required>
		            <OPTION value="" selected>SELECCIONAR...</OPTION>
		            <?php   
...
<div class="form-row justify-content-center">
			...
			<div class="form-group col-md-5 col-sm-6">
				...
				<input type="submit" name="guardar" id="guardar" value="Enviar" class="form-control btn-dark" onclick="EnviarProcesoKG(); return false" disabled="">
			</div>
</div>
